...
const faqs = [
  { q: 'How do I place an order?',            a: 'Browse our products, add items to your cart, and proceed to checkout. Fill in your delivery details and click "Place Order". It\'s that easy!' },
  { q: 'What payment methods do you accept?', a: 'We currently offer Cash on Delivery (COD). You pay only when your order arrives at your door — no online payments required!' },
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '64px 24px' }}>
      <div style={{ textAlign: 'center', marginBottom: 56 }}>
        ...
        <p style={{ fontSize: 17, color: '#6b7280' }}>Everything you need to know about shopping with us 🌸</p>
      </div>
      ...
      <div style={{ marginTop: 48, background: 'linear-gradient(135deg,#fce4ec,#f3e5f5)', borderRadius: 20, padding: '32px', textAlign: 'center' }}>
        ...
        <p style={{ color: '#4b5563', marginBottom: 20 }}>Message us on social media — we're happy to help! 💖</p>
        <a href="https://www.facebook.com/share/17Qros4sRV/" target="_blank" rel="noreferrer"
           className="btn-primary" style={{ textDecoration: 'none' }}>Contact Us</a>
      </div>
    </div>
  );
}
